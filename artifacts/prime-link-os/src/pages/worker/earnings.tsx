  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-white/30 text-sm mt-1">Payment history and status</p>
      </div>
      ...
      {newPending.length > 0 && (
        <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-2xl p-5 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-400/60 mt-0.5">{newPending.length} task payment{newPending.length > 1 ? "s" : ""} approved — admin will pay soon</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-5">
          ...
          <div className="text-xs text-white/30 mt-1">Awaiting Payment</div>
        </div>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/5 rounded-2xl overflow-hidden">
        ...
        <div className="divide-y divide-white/5">
          ...
          {earnings.length === 0 && (
            <p className="px-6 py-12 text-center text-white/20 text-sm">No earnings yet. Complete tasks to earn payments.</p>
          )}
        </div>
      </div>
    </div>
